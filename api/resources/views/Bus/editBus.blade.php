<x-layout>
        <div class="flex-1 bg-white rounded-lg shadow p-6">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="/buslist" class="text-gray-500 hover:text-gray-700">
                    <i class="fas fa-times text-xl"></i>
                </a>
            </div>

            <form action="/addbus/{{$bus->id}}" class="space-y-6" method="post">
                @csrf
                @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text"
                                  name="BusNumber" 
                                     ...
                                     value="{{ old('BusNumber', $bus->BusNumber)}}"
                            >
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text"
                                ...
                                required 
                                class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary-600 focus:border-transparent" 
                                value="{{old('LicensePlate',$bus->LicensePlate)}}"
                             >
                        </div>
                ...
                <div class="bg-gray-50 p-6 rounded-lg">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="number" 
                                name="TotalCapacity" min="1" 
                                class="w-full border rounded-lg px-4 py-2 bg-gray-100"
                                value="{{old('TotalCapacity',$bus->TotalCapacity)}}"
                            >
                        </div>
                    </div>
                     <h3 class="text-lg font-medium text-gray-800 mb-4 flex items-center">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select required  
                                name="Status" 
                                class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary-600"                      
                            >
